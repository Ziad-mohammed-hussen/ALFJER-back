...
const { register, login, getMe, getUsers, signup, transferTeacher, registerParent, updateUser, deleteUser, getHierarchy, seedUsers } = require('../controllers/authController');
